...
export SOLVER_TESTER_ACCOUNT=solver-beta.testnet
...
near call $SOLVER_REGISTRY_CONTRACT create_liquidity_pool '{"token_ids":["'$WNEAR_TOKEN'","'$USDC_TOKEN'"],"fee":'$FEE'}' --accountId $SOLVER_TESTER_ACCOUNT --deposit 1.5 --gas 300000000000000

# deposit NEAR for wNEAR
near call $WNEAR_TOKEN storage_deposit '{"account_id":"'$SOLVER_TESTER_ACCOUNT'","registration_only":true}' --accountId $SOLVER_TESTER_ACCOUNT --deposit 0.00125
