...
near call $SOLVER_REGISTRY_CONTRACT create_liquidity_pool '{"token_ids":["'$WNEAR_TOKEN'","'$USDC_TOKEN'"],"fee":'$POOL_FEE'}' --accountId $SOLVER_TESTER_ACCOUNT --deposit 1.5 --gas 300000000000000
